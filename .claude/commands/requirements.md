...
Nach Approval: Feature-File speichern. Dann `project-config.md` aktualisieren:

```bash
# Aktuellen Wert lesen und um 1 erhöhen
grep "Nächste freie ID" project-config.md
# → Beispiel: "Nächste freie ID: FEAT-3" → ersetze durch "Nächste freie ID: FEAT-4"
```
